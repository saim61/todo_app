defmodule TodoAppWeb.TodoLiveTest do
  ...
  @create_attrs %{date: "2023-09-16", description: "some description", priority: :"low,medium,high", title: "some title"}
  @update_attrs %{date: "2023-09-17", description: "some updated description", priority: :"low,medium,high", title: "some updated title"}
